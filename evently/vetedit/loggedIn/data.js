function(r) {
  ...
  if (r._rev) {
    ...
    var result = {
        ...
        guardian_pref_phone:   fixPhone(r["Preferred-Guardian-Phone-Number"]),
        ...
        addr_state:            r.State,
        addr_zip:              r.Zip,
        addr_phone_day:        fixPhone(r["Primary-Phone"]),
        addr_phone_mbl:        fixPhone(r["Mobile-Phone"]),
        ...
        ac_addr_phone:         fixPhone(r["Emergency-Contact-Phone"]),
